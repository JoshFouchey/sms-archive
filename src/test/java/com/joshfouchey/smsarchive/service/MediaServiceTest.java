...
class MediaServiceTest extends EnhancedPostgresTestContainer {
    ...
    void setUp() {
        ...
        Contact c1 = Contact.builder().number("+1 (555) 111-1111").normalizedNumber("15551111111").name("Alice").build();
        Contact c2 = Contact.builder().number("+1 (555) 222-2222").normalizedNumber("15552222222").name("Bob").build();
